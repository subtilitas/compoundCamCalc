...
import { camToWorld, freeBody as freeBodyOf, layout as layoutOf, tangentAngle } from './statics.js';
...
/**
 * Bow layout of the test geometry (tests/unit/statics.js).
 * @param {Support} s string pitch line
 */
const layout = (s) => layoutOf(geometry, s);

/**
 * Free-body statics of sample i of a forward result with the test limb
 * (tests/unit/statics.js).
 * @param {ForwardResult} r
 * @param {number} i sample
 * @param {Support} s string pitch line
 * @param {Support} c cable pitch line
 */
const freeBody = (r, i, s, c) => freeBodyOf(r, i, s, c, geometry, limb);
